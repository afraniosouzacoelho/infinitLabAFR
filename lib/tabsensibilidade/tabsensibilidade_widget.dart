...
import 'tabsensibilidade_model.dart';
export 'tabsensibilidade_model.dart';

class TabsensibilidadeWidget extends StatefulWidget {
  const TabsensibilidadeWidget({
    super.key,
    this.nomecliente,
    this.nomeusuario,
    this.email,
  ...
  @override
  State<TabsensibilidadeWidget> createState() => _TabsensibilidadeWidgetState();
}

class _TabsensibilidadeWidgetState extends State<TabsensibilidadeWidget> {
  late TabsensibilidadeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TabsensibilidadeModel());
              ...
              return Column(
                ...
                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          _model.apiResult2s6 =
                                              await GetsensibilidadeCall.call(
                                            id: int.tryParse(
                                          ...
                                          if ((_model.apiResult2s6?.succeeded ??
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: const Text(
                                                      'Erro busca sensibilidade OPS!!! ERRO'),
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          _model.apiResultpq6 =
                                              await SavesensibilidadeCall.call(
                                            id: int.tryParse(
                                                _model.textController1.text),
                                            customer:
                                                widget.nomecliente?.toString(),
                                            codigo: _model.textController2.text,
                                            descricao:
                                                _model.textController3.text,
                                            incluir:
                                          ...
                                          if ((_model.apiResultpq6?.succeeded ??
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: const Text(
                                                      'Salvar grupo antibióticos  processado ok'),
                                                  content: Text(getJsonField(
                                                    (_model.apiResultpq6
                                                            ?.jsonBody ??
                                                        ''),
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: const Text(
                                                      'Erro em salva grupo antibióticos. OPS!!! ERRO'),
                                                  content: Text(getJsonField(
                                                    (_model.apiResultpq6
                                                            ?.jsonBody ??
                                                        ''),
                  ...
                  FutureBuilder<ApiCallResponse>(
                    future: GetsensibilidadesCall.call(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final listViewGetsensibilidadesResponse = snapshot.data!;

                      return Builder(
                        builder: (context) {
                          final viewexamesmaterial = getJsonField(
                            listViewGetsensibilidadesResponse.jsonBody,
                            r'''$.ok[:]''',
                          ).toList();
