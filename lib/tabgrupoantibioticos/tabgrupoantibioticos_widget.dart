...
import 'tabgrupoantibioticos_model.dart';
export 'tabgrupoantibioticos_model.dart';

class TabgrupoantibioticosWidget extends StatefulWidget {
  const TabgrupoantibioticosWidget({
    super.key,
    this.nomecliente,
    this.nomeusuario,
    this.email,
  ...
  @override
  State<TabgrupoantibioticosWidget> createState() =>
      _TabgrupoantibioticosWidgetState();
}

class _TabgrupoantibioticosWidgetState
    extends State<TabgrupoantibioticosWidget> {
  late TabgrupoantibioticosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TabgrupoantibioticosModel());
              ...
              return Column(
                ...
                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          _model.apiResult2s6 =
                                              await GetgrupoantibioticosCall
                                                  .call(
                                            id: int.tryParse(
                                          ...
                                          if ((_model.apiResult2s6?.succeeded ??
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: const Text(
                                                      'Erro busca grupo antibiótico OPS!!! ERRO'),
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          _model.apiResultpq6 =
                                              await SavegrupoantibioticosCall
                                                  .call(
                                            id: int.tryParse(
                                                _model.textController1.text),
                                            customer:
                  ...
                  FutureBuilder<ApiCallResponse>(
                    future: GetgruposantibioticosCall.call(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final listViewGetgruposantibioticosResponse =
                          snapshot.data!;

                      return Builder(
                        builder: (context) {
                          final viewexamesmaterial = getJsonField(
                            listViewGetgruposantibioticosResponse.jsonBody,
                            r'''$.ok[:]''',
                          ).toList();
