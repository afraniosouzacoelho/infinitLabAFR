...
import 'tabmateriaiscoleta_model.dart';
export 'tabmateriaiscoleta_model.dart';

class TabmateriaiscoletaWidget extends StatefulWidget {
  const TabmateriaiscoletaWidget({
    super.key,
    this.nomecliente,
    this.nomeusuario,
    this.email,
  ...
  @override
  State<TabmateriaiscoletaWidget> createState() =>
      _TabmateriaiscoletaWidgetState();
}

class _TabmateriaiscoletaWidgetState extends State<TabmateriaiscoletaWidget> {
  late TabmateriaiscoletaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TabmateriaiscoletaModel());
              ...
              return Column(
                ...
                children: [
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          _model.apiResult2s6 =
                                              await GetmaterialcoletaCall.call(
                                            id: int.tryParse(
                                          ...
                                          if ((_model.apiResult2s6?.succeeded ??
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: const Text(
                                                      'Erro busca material coleta OPS!!! ERRO'),
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          _model.apiResultpq6 =
                                              await SavematerialcoletaCall.call(
                                            id: int.tryParse(
                                                _model.textController1.text),
                                            customer:
                                                widget.nomecliente?.toString(),
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            'Codigo material no equipamento:',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily: 'Readex Pro',
                  ...
                  FutureBuilder<ApiCallResponse>(
                    future: GetmateriaiscoletaCall.call(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final listViewGetmateriaiscoletaResponse = snapshot.data!;

                      return Builder(
                        builder: (context) {
                          final viewmateriaiscoleta = getJsonField(
                            listViewGetmateriaiscoletaResponse.jsonBody,
                            r'''$.ok[:]''',
                          ).toList();
                          ...
                          return ListView.builder(
                            ...
                            itemCount: viewmateriaiscoleta.length,
                            itemBuilder: (context, viewmateriaiscoletaIndex) {
                              final viewmateriaiscoletaItem =
                                  viewmateriaiscoleta[viewmateriaiscoletaIndex];
                              return Row(
                                mainAxisSize: MainAxisSize.max,
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
