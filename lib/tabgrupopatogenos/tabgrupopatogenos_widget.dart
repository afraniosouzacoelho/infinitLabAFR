...
import 'tabgrupopatogenos_model.dart';
export 'tabgrupopatogenos_model.dart';

class TabgrupopatogenosWidget extends StatefulWidget {
  const TabgrupopatogenosWidget({
    super.key,
    this.nomecliente,
    this.nomeusuario,
    this.email,
  ...
  @override
  State<TabgrupopatogenosWidget> createState() =>
      _TabgrupopatogenosWidgetState();
}

class _TabgrupopatogenosWidgetState extends State<TabgrupopatogenosWidget> {
  late TabgrupopatogenosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TabgrupopatogenosModel());
              ...
              return Column(
                ...
                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          _model.apiResult2s6 =
                                              await GetgrupopatogenoCall.call(
                                            id: int.tryParse(
                                          ...
                                          if ((_model.apiResult2s6?.succeeded ??
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: const Text(
                                                      'Erro busca grupo patógenos OPS!!! ERRO'),
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          _model.apiResultpq6 =
                                              await SavegrupopatogenosCall.call(
                                            id: int.tryParse(
                                                _model.textController1.text),
                                            customer:
                                                widget.nomecliente?.toString(),
                                          ...
                                          if ((_model.apiResultpq6?.succeeded ??
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: const Text(
                                                      'Salvar grupo patógenos  processado ok'),
                                                  content: Text(getJsonField(
                                                    (_model.apiResultpq6
                                                            ?.jsonBody ??
                                                        ''),
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: const Text(
                                                      'Erro em salva grupo patógenos OPS!!! ERRO'),
                                                  content: Text(getJsonField(
                                                    (_model.apiResultpq6
                                                            ?.jsonBody ??
                                                        ''),
                  ...
                  FutureBuilder<ApiCallResponse>(
                    future: GetgrupospatogenosCall.call(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final listViewGetgrupospatogenosResponse = snapshot.data!;

                      return Builder(
                        builder: (context) {
                          final viewexamesmaterial = getJsonField(
                            listViewGetgrupospatogenosResponse.jsonBody,
                            r'''$.ok[:]''',
                          ).toList();
